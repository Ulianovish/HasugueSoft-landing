...
export function Footer() {
  ...
  // Desarrollo Agéntico
  solutions.push({
    methodology: 'Metodología Agéntica',
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="hidden md:flex flex-col sm:flex-row justify-between items-center gap-8">
          <div className="flex items-center space-x-4">
            <img src="/images/hasugue-logo.svg" alt="Hasugue" className="h-14 hasugue-logo" />
            <FooterPopup />
          </div>

          <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="text-muted-foreground text-xs">
              &copy; {new Date().getFullYear()} Hasugue. All rights reserved.
            </div>

            <div className="flex items-center gap-4">
              <Button
                onClick={() => (window.location.href = "/support")}
                className="bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-medium px-4 py-2 text-sm"
              >
        ...
        <div className="md:hidden space-y-6">
          ...
          <div className="text-center space-y-4">
            <img src="/images/hasugue-logo.svg" alt="Hasugue" className="h-12 mx-auto hasugue-logo" />
            <div className="text-muted-foreground text-xs">
              &copy; {new Date().getFullYear()} Hasugue. All rights reserved.
            </div>
          </div>
          ...
          <div className="text-center space-y-4 pt-4 border-t border-border/30">
            ...
            <Button
              onClick={() => (window.location.href = "/support")}
              className="w-full bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-medium px-4 py-2 text-sm"
            >
              <MessageSquare className="w-4 h-4 mr-2" />
              Start Chat
            </Button>
