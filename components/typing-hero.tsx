...
export function TypingHero() {
  ...
  const phrases = [
    { text: "automatización inteligente", color: "text-purple-400", cursorColor: "bg-purple-400" },
    { text: "desarrollo agéntico", color: "text-blue-400", cursorColor: "bg-blue-400" },
    { text: "soluciones PyME", color: "text-orange-400", cursorColor: "bg-orange-400" },
  ]

  const baseText = "Creamos "
