...
export function ServicesSection() {
  ...
  const services = [
    ...
    },
    {
      ...
      shortTitle: "Agéntico",
      tagline: "Metodología Agéntica",
      description:
        "Desarrollo de software agéntico usando metodología agéntica para soluciones inteligentes que se adaptan y evolucionan",
      ...
      rating: 5.0,
      projects: 45,
      keyFeatures: ["Desarrollo con IA", "Metodología Agéntica", "Soluciones Personalizadas", "Escalabilidad Garantizada"],
      results: "70% reducción de tiempo • 250% eficiencia mejorada • 98% satisfacción cliente",
      technologies: ["Metodología Agéntica", "IA", "Next.js", "TypeScript"],
    },
    {
      id: "software",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-8">
            ...
            <h2 className="text-5xl sm:text-7xl font-black bg-clip-text text-transparent bg-gradient-to-r from-foreground via-primary to-purple-400 leading-tight">
              Services We
              <span className="block text-purple-400">Offer</span>
            </h2>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    ...
                    <div
                      className={`text-center p-4 rounded-xl bg-gradient-to-br ${currentService.bgGradient} border border-primary/20`}
                    >
                      <div className="text-2xl font-bold text-purple-400">{currentService.projects}+</div>
          ...
          {/* Bottom CTA */}
          <motion.div variants={itemVariants} className="text-center space-y-8">
            <div className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-primary/10 to-purple-500/10 rounded-full border border-primary/20 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-primary to-purple-500 hover:from-primary/90 hover:to-purple-500/90 text-white font-bold px-12 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
              >
