      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-6">
            <div className="inline-flex items-center space-x-2 px-6 py-3 bg-purple-500/10 rounded-full border border-purple-500/20 backdrop-blur-sm">
          <Sparkles className="w-5 h-5 text-purple-400 animate-pulse" />
          <span className="text-lg font-bold text-purple-400">Our Services</span>
          <Sparkles className="w-5 h-5 text-purple-400 animate-pulse" />
            </div>

            <h2 className="text-4xl sm:text-5xl font-bold">
              <span className="text-white">Services We </span>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-blue-400 to-violet-400">
                Offer
              </span>
            </h2>
          ...
          >
            {services.map((service, index) => (
              ...
              >
                <Card
                  className={`relative h-full w-full rounded-2xl border border-gray-800 bg-gray-900/50 backdrop-blur-sm overflow-hidden hover:border-gray-600 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 ${
                    service.size === "large"
                      ? "min-h-[320px]"
                      : service.size === "medium"
                        ? "min-h-[280px]"
                  ...
                  <span className="text-purple-400 font-bold">{service.price}</span>
                    ...
                    <div className="mt-4">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="w-full border border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white transition-all duration-300 group-hover:border-purple-500 group-hover:text-purple-400 relative overflow-hidden"
                      >
                        <motion.div
          ...
          <motion.div variants={itemVariants} className="text-center pt-8">
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-bold px-12 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-purple-500 text-purple-400 hover:bg-purple-500/10 px-12 py-4 text-lg"
              >
