            ...
            <motion.div variants={itemVariants} className="lg:col-span-8 space-y-6">
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <h2 className="text-2xl font-bold">HasugueSoft</h2>
                  <motion.div
                ...
                <p className="text-primary text-sm">Años de experiencia enterprise</p>
              ...
              <h3 className="text-3xl sm:text-4xl font-bold leading-tight">
                Ayudamos a PyMEs colombianas a automatizar procesos críticos con desarrollo agéntico que es rápido, eficiente y construido para generar resultados medibles.
              </h3>
            </motion.div>
          </div>
              ...
              <div className="h-full rounded-lg border border-border bg-background/50 p-6 hover:border-primary/50 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <p className="text-sm text-muted-foreground">Dato 01</p>
                    <motion.div
                      animate={{ rotate: 360 }}
                  ...
                  <p className="text-muted-foreground">de los clientes nos recomiendan a otros clientes</p>
                  ...
                  <div className="pt-2 pb-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <p className="text-xs text-muted-foreground italic">
                        "Su experiencia en desarrollo web y sistemas empresariales transformó completamente nuestras operaciones."
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    ...
                    >
                      ...
                      <span className="font-medium">Socios B2B</span>
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, scale: 0 }}
                      animate={{ opacity: 1, scale: 1 }}
                      transition={{ delay: 0.9 }}
                      className="px-3 py-1.5 bg-gradient-to-r from-purple-500/10 to-purple-500/5 border border-purple-500/20 rounded-full text-purple-400 text-xs flex items-center space-x-1 shadow-sm hover:shadow-md transition-shadow"
                    >
                      <TrendingUp className="w-3 h-3" />
                      <span className="font-medium">Tasa de Crecimiento</span>
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, scale: 0 }}
                      animate={{ opacity: 1, scale: 1 }}
            ...
            <motion.div variants={itemVariants} className="group">
              <div className="h-full rounded-lg border border-border bg-background/50 p-6 hover:border-primary/50 transition-all duration-300">
                <div className="space-y-6">
                  <div className="space-y-4">
                    <h3 className="text-2xl font-bold">Un proceso optimizado, ejecutado con cuidado metódico.</h3>
                    <p className="text-muted-foreground">
                       Transformamos marcas abrumadoras en experiencias destacadas, construidas para reflejar la calidad,
                       ambición y grandeza
                     </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm">Sitio web y marca para Sony</p>
                    </div>
              ...
              <div className="h-full rounded-lg border border-border bg-background/50 p-6 hover:border-primary/50 transition-all duration-300 relative overflow-hidden">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                      <p className="text-sm text-muted-foreground">Dato 02</p>
                      <ViewportTriggeredCountUp />
                      <p className="text-muted-foreground">Recaudado por las marcas con las que nos hemos asociado</p>
                    </div>
                    <div className="flex items-center space-x-2 px-3 py-2 bg-background/50 backdrop-blur-sm border border-border/30 rounded-full self-start lg:self-center">
                      <span className="text-xs text-muted-foreground">impulsado por</span>
                      <img src="/images/hasugue-logo.svg" alt="Hasugue" className="h-6 hasugue-logo" />
                    </div>
                  </div>
    ...
    <div ref={ref} className="relative">
      ...
      <div className="flex flex-wrap gap-4 mt-2">
        ...
        <div className="flex items-center space-x-1">
          ...
          <span className="text-sm">+32% Crecimiento</span>
        </div>
      </div>
...
function AnimatedTimelineChart(): ReactElement {
  ...
  const stages = [
    { name: "Descubrimiento", duration: "1 Semana", position: 20, color: "#6b7280" },
    { name: "Concepto", duration: "2 Semanas", position: 50, color: "#6b7280" },
    { name: "Ejecución", duration: "3 Semanas", position: 80, color: "#6b7280" },
  ]
      ...
      >
        <div className="h-5 w-auto">
          <img
            ...
            alt="Hasugue"
            className="h-5 w-auto object-contain filter grayscale opacity-70 hover:opacity-100 transition-opacity hasugue-logo"
          />
        </div>
        <div className="h-5 w-auto">
          <img
...
function ServiceSelectionCard(): ReactElement {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: ["Startup", "Pequeña Empresa", "Empresa Grande", "Sin Fines de Lucro"],
    },
    {
      id: "companySize",
    ...
    },
    {
      ...
      options: ["Aumentar Ingresos", "Mejorar Eficiencia", "Escalar Operaciones", "Transformación Digital"],
    },
    {
      id: "budget",
    ...
    {
      id: "timeline",
      question: "¿Cuál es tu cronograma?",
      options: ["Lo Antes Posible", "1-3 Meses", "3-6 Meses", "6+ Meses"],
    },
    {
      id: "location",
      question: "¿Dónde está ubicado tu negocio?",
      options: ["América del Norte", "Europa", "Asia", "Otro"],
    },
    {
      id: "contactName",
      question: "¿Quién es el contacto principal para este proyecto?",
      type: "input",
      placeholder: "Ingresa tu nombre completo",
    },
    {
      id: "email",
      question: "¿Cuál es el mejor email para contactarte?",
      type: "input",
...
Submitted at: ${new Date().toLocaleString()}
      ...
      <div className="h-full rounded-lg border border-border bg-black text-white overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold">Consulta de {selectedServiceData?.name}</h3>
        ...
        <div className="p-4">
          ...
          {currentQuestionData.type === "input" ? (
            <form onSubmit={handleCustomAnswer} className="space-y-4">
              <input
                ...
                name="customAnswer"
                className="w-full p-3 bg-gray-900 border border-gray-700 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none"
                placeholder={currentQuestionData.placeholder}
                required
              />
              <button
                type="submit"
                className="w-full p-3 bg-purple-500 text-black font-medium rounded-lg hover:bg-purple-400 transition-colors"
              >
                Continuar
              </button>
            </form>
            ...
            <div className="grid grid-cols-2 gap-3">
              {currentQuestionData.options?.map((option) => (
                <button
                  ...
                  className="p-3 border border-gray-700 rounded-lg hover:border-purple-500 hover:bg-purple-500/10 transition-all duration-200 text-left"
                >
                  <span className="text-purple-400 font-medium text-sm">{option}</span>
                </button>
              ))}
            </div>
          )}
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">{questions.length - currentQuestion - 1} preguntas restantes</p>
          </div>
        </div>
      </div>
    )
        ...
        <div className="text-center space-y-4">
          ...
          <div className="pt-4">
            <button
              ...
              className="px-4 py-2 bg-purple-500 text-black rounded-lg hover:bg-purple-400 transition-colors text-sm font-medium"
            >
  ...
  return (
    <div className="h-full rounded-lg border border-border bg-background/50 p-6 hover:border-primary/50 transition-all duration-300">
      <div className="space-y-4">
        <div>
                <h3 className="text-2xl font-bold mb-2">Selecciona un Servicio</h3>
                <p className="text-muted-foreground">Elige el servicio que te interesa para iniciar una consulta</p>
              </div>
