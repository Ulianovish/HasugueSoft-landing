...
export function NavBar() {
  ...
  const navItems = [
    ...
    { name: "Alianzas", href: "/partnership", icon: <Handshake className="w-4 h-4" /> },
  ]
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Link href="/consultation" onClick={scrollToTop}>
              <Button className="bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-medium">
            ...
            >
              <div className="px-4 py-6 space-y-4">
                ...
                <div className="pt-4 border-t border-gray-700">
                  ...
                  >
                    <Button className="w-full bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 text-white font-medium">
                      <Zap className="w-4 h-4 mr-2" />
                      Demo Gratuita
                    </Button>
                  </Link>
