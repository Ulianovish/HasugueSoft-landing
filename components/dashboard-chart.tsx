  ...
  const metrics = [
    {
      ...
      color: "#10b981",
      description: "Ingresos totales generados para nuestros clientes",
      details: "A través de 47 proyectos exitosos",
    },
    {
      title: "Client Growth",
      value: "2,847%",
      ...
      color: "#3b82f6",
      description: "Crecimiento empresarial promedio alcanzado",
      details: "En los primeros 12 meses",
    },
    {
      title: "Active Users",
      value: "1.2M+",
      ...
      color: "#8b5cf6",
      description: "Usuarios en plataformas que hemos construido",
      details: "En todas las aplicaciones de clientes",
    },
    {
      title: "Success Rate",
      value: "98.7%",
      ...
      color: "#f59e0b",
      description: "Tasa de éxito del proyecto",
    details: "Entrega a tiempo y dentro del presupuesto",
    },
  ]
    ...
    >
      ...
      <div className="relative z-10 mb-6">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-lg font-semibold text-white">Métricas de Impacto del Cliente</h3>
        ...
        <p className="text-gray-400 text-sm">Resultados reales de nuestras asociaciones con clientes</p>
      </div>
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-center space-x-2">
                <span className="text-purple-400 text-sm font-medium">{currentMetric.change}</span>
      ...
      <div className="absolute bottom-4 right-4 flex items-center space-x-2 px-3 py-1.5 bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-700/50">
        <span className="text-xs text-gray-400">impulsado por</span>
        <img src="/images/hasugue-logo.svg" alt="Hasugue" className="h-4 hasugue-logo" />
      </div>
