...
export default function ContactPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "Hello! I'm Hasugue's AI assistant. How can I help you with your project today?",
      sender: "bot",
      timestamp: new Date(),
    },
  ])
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "hello@hasugue.com",
      description: "Send us an email anytime",
      href: "mailto:hello@hasugue.com",
    },
    {
      icon: Phone,
      title: "Phone",
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <h3 className="text-xl font-bold">Hasugue AI Assistant</h3>
                        <motion.div
